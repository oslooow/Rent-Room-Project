    ...
    <div class="relative mx-auto max-w-screen-xl px-4 py-8">
      <div class="grid grid-cols-1 items-start gap-8 md:grid-cols-2">
        <div class="grid grid-cols-2 gap-4 md:grid-cols-1">
          <img
            alt="Les Paul"
            :src="accomDetail.imgUrl"
            class="aspect-square w-full rounded-xl object-cover"
          />
          <div v-html="accomDetail.qrCode"></div>
        ...
        >
          ...
          <div class="mt-8 flex justify-between">
            ...
            <p class="text-lg font-bold">
              {{
                accomDetail.price.toLocaleString('id-ID', { style: 'currency', currency: 'IDR' })
              }}
            </p>
          </div>
          ...
          <div class="mt-4">
            <div class="prose max-w-none">
              <p>
                {{ accomDetail.facility }}
              </p>
            </div>

            <button class="mt-2 text-sm font-medium underline">Scan</button>
          </div>
          ...
          <form class="mt-8">
            ...
            <div class="mt-8 flex gap-4">
              ...
              <!-- <div class="-ml-0.5 flex">{{ accomDetail.qrCode }}</div> -->
            </div>
          </form>
        </div>
      </div>
...
export default {
  computed: {
    ...mapState(useAppStore, ['accomDetail'])
  },
  methods: {
    ...mapActions(useAppStore, ['fetchAccomDetail'])
  },
  created() {
    let id = this.$route.params.id
    this.fetchAccomDetail(id)
  }
}
</script>
